...
def initializeCharacterTemplates(dataDir, twCubes, charDef):
    """
    ...
    for char, charAbbr, thisCharLen in zip(charDef['charList'], charDef['charListAbbr'], charDef['charLen']):
     ...
     #   print("Length of neural cube is ", char, neuralCube.shape)
     #   print(twCubes[char]);
      ...
      #  print("CurrChar is ", char, thisCharLen, len(neuralCube[59:(59+thisCharLen+1),:]))
        if "IamOnline" in dataDir:
          neuralCube = neuralCube[0:(0+thisCharLen+1),:]
        else:
