...
class charSeqRNN(object):
    ...
    def __init__(self, args):
        ...
        #Changing begin Nithin
      #  with tf.variable_scope("layer1a"):
      #      self.rnnOutput1, self.rnnWeightVars1 = cudnnGraphSingleLayer(self.args['nUnits'], 
      #                                                             initRNNState, 
      #                                                             self.rnnOutput[:,0::1,:],  
     #                                                              self.args['timeSteps'], 
     #                                                              self.args['batchSize'], 
     ...
     #                                                              self.args['directionality'])
        ...
        with tf.variable_scope("layer2"):
            self.rnnOutput2, self.rnnWeightVars2 = cudnnGraphSingleLayer(self.args['nUnits'], 
                                                                         initRNNState, 
                                                                         self.rnnOutput[:,0::skipLen,:], # Nithin change Output to 1
