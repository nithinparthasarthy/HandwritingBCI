...
def labelDataset(dataDir, sentenceDat, singleLetterDat, twCubes, trainPartitionIdx, testPartitionIdx, charDef):
    """
    ...
    templates = initializeCharacterTemplates(dataDir, twCubes, charDef)
